app.controller("keycloakController", function($rootScope, $scope, $http, $location, $window, $localStorage, $templateCache) {
//    const contextPath = 'http://localhost:8187/market-auth/api/v1';
    const contextPath = 'http://localhost:8180/realms/SpringBootKeycloak';
    ...
    $scope.loginKeycloakUser = function() {
    console.log('Вызов loginKeycloakUser!!!!!!!!')
